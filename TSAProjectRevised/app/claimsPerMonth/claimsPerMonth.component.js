...
angular.module('claimsPerMonth')
  .component('claimsPerMonth', {
    ...
    controller: ('claimsPerMonth', ['$scope', '$window', function($scope, $window) {
    ...
    var calcTotalValLoss = function() {
        ...
        $scope.totalValLoss = $scope.totalValLoss.toFixed(0);
    }
    ...
    $scope.add = function() {
      ...
      var pushObj = {
        airline: "N/A",
        value: "N/A",
        airport: $scope.inputAirport
      }

      $scope.lastClaimEntered = $scope.inputAirport + " " + month + "/" + year;
